...
2. Run `npm ci` within the specific addon folder: `addons/importer`
...
For more information, please check the official [Masterportal documentation](https://bitbucket.org/geowerkstatt-hamburg/masterportal/src/dev/docs/Dev/Tutorials/addOnsVue.md).
